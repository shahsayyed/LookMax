...
echo ""
echo "This pipeline is fully isolated from ML/pipeline/dataset_generator/ (the vision image"
echo "pipeline) -- separate requirements.txt, separate data folder (ML/data/5_Stylist_LLM/),"
