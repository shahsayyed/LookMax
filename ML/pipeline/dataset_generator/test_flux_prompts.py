...
TEST_PROMPTS = {
    ...
    "test_women_grooming.png": "A front-facing head-and-shoulders portrait, perfectly centered face, straight-on eye-level camera angle, looking directly at the camera, bright even studio lighting of a 35-year-old East Asian woman, slim, frizzy highly messy unbrushed hair with a visible grease sheen at the roots, uneven poorly blended foundation with a harsh visible demarcation line at the jaw, smudged eyeliner, dry cracked flaky lips. Photorealistic, ultra detailed, 85mm lens.",
